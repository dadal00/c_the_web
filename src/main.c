...
int main()
{
    ...
    /*
        Get a file descriptor for our server to listen as a connection Input/Output
    ...
    */
    ...
    // Tell the OS to send data from our SERVER address to our SOCKET file descriptor
    // If error, exit
    ...
    while (1)
    {
        // Blocks until new connection, creates a new client socket (file descriptor) fit for the server information
